        ...
        <div className='w-full flex flex-col gap-2 mt-4'>
          ...
          <div className='flex flex-col justify-between text-white mx-auto  gap-3'>
            ...
            <div className='self-end my-2'>
              <button className='bg-[#126D8D] px-6 py-1 mx-2 rounded-lg' onClick={() => {navigate("/editprofile")}}>EDIT</button>
              <button className='bg-[#126D8D] px-2 py-1 mx-2 rounded-lg' onClick={() => {navigate("/ngoprofile")}}>VIEW PROFILE</button>
            </div>
